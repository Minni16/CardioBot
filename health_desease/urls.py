...
urlpatterns = [
    ...
    # path('prdict_heart_disease', #_heart_disease,name="prdict_heart_disease"),
    path('add_heartdetail', add_heartdetail,name="add_heartdetail"),
    path('view_search_pat', view_search_pat,name="view_search_pat"),
    path('view_prediction_history/<int:search_id>', view_prediction_history, name="view_prediction_history"),
